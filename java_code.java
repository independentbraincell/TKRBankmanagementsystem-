...
class login
{
    ...
    void accept()
    {
        try{
            System.out.println("--------------------------------------------------------------------------------");
            System.out.println("\n\t\tWelcome to TKR's Bank Management System\n");
...
class bank
{
    ...
    static void mainmenu()
    {
        try{
            ...
            do{
                System.out.println("-------------------------------------------------------------------------------");
                System.out.println("\t\t\t TKR's Bank Management System");
                System.out.println("-------------------------------------------------------------------------------\n\n");
                ...
                switch(choice)
                {
                    ...
                    case 7 : transfer();
                    break;
                    case 8 : System.out.println("Are you sure you want to quit? (y/n) : ");
